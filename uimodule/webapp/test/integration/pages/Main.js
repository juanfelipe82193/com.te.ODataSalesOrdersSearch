sap.ui.require([
  ...
  var sViewName = "com.te.ODataSalesOrdersSearch.view.MainView";
      ...
      assertions: {
          ...
          iShouldSeeTheTitle: function () {
            return this.waitFor({
              ...
              properties: {
                text: "com.te.ODataSalesOrdersSearch"
              },
              success: function() {
                Opa5.assert.ok(true, "The page shows the correct title");
              },
              errorMessage: "App does not show the expected title com.te.ODataSalesOrdersSearch"
            });
        }
      }
